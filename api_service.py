...
class WindDirection(IntEnum):
    """
    In the API response, the wind direction is given in degrees.
    I decided to put them in a more convenient format.
    To do this, I created an enumeration of the main wind directions.
    """
